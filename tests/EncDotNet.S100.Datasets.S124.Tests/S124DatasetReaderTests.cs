...
public class S124DatasetReaderTests
{
    ...
    public void PointDataset_NavwarnPart_HasPointGeometry()
    {
        ...
        Assert.Equal(S100GeometryType.Point, f1.GeometryType);
    ...
    public void PointDataset_TextPlacement_HasPointGeometry()
    {
        ...
        Assert.Equal(S100GeometryType.Point, f3.GeometryType);
    ...
    public void SurfaceDataset_PointInsideArea_ParsedCorrectly()
    {
        ...
        Assert.Equal(S100GeometryType.Point, f2.GeometryType);
    ...
    public void MixedDataset_ContainsAllGeometryTypes()
    {
        ...
        Assert.Contains(ds.Features, f => f.GeometryType == S100GeometryType.Point);
        Assert.Contains(ds.Features, f => f.GeometryType == S100GeometryType.Curve);
        Assert.Contains(ds.Features, f => f.GeometryType == S100GeometryType.Surface);
        Assert.Contains(ds.Features, f => f.GeometryType == S100GeometryType.None);
    }
