...
public class S201DatasetReaderTests
{
    ...
    public void Open_PointDataset_ReturnsFeaturesAndInfoTypes()
    {
        ...
        Assert.Equal(S100GeometryType.Point, lateralBuoy.GeometryType);
    ...
    public void Open_XlinkDataset_FeatureReferencesAreSeparatedFromInfoRefs()
    {
        ...
        Assert.Equal(S100GeometryType.None, aggregation.GeometryType);
        Assert.Equal(2, aggregation.FeatureReferences.Count);
