...
`LightSectored`), `TopmarksAbsorbed` (`TOPMAR` slaves folded into a
master's `topmark` complex), `NauticalInformationTypesEmitted` (`NauticalInformation`
