...
function CardinalBuoy(feature, featurePortrayal, contextParameters)
	...
	if feature.PrimitiveType == PrimitiveType.Point then
		if contextParameters.SimplifiedSymbols then
			...
			-- Black,Yellow,Black
			if feature.buoyShape == 2 and feature.colour[1] == 2 and feature.colour[2] == 6 and feature.colour[3] == 2 and feature.topmark then
				featurePortrayal:AddInstructions('PointInstruction:BOYCAREB')
			...
			elseif feature.buoyShape == 5 and feature.colour[1] == 2 and feature.colour[2] == 6 and feature.colour[3] == 2 then
				featurePortrayal:AddInstructions('PointInstruction:BOYCARES')
			
				-- Yellow,Black,Yellow			
			elseif feature.buoyShape == 2 and feature.colour[1] == 6 and feature.colour[2] == 2 and feature.colour[3] == 6 and feature.topmark then
				featurePortrayal:AddInstructions('PointInstruction:BOYCARWB')
			...
			elseif feature.buoyShape == 5 and feature.colour[1] == 6 and feature.colour[2] == 2 and feature.colour[3] == 6 then
				featurePortrayal:AddInstructions('PointInstruction:BOYCARWS')
			
				-- Black,Yellow
			elseif feature.buoyShape == 2 and feature.colour[1] == 2 and feature.colour[2] == 6 and feature.topmark then
				featurePortrayal:AddInstructions('PointInstruction:BOYCARSB')
			...
			elseif feature.buoyShape == 5 and feature.colour[1] == 2 and feature.colour[2] == 6 then
				featurePortrayal:AddInstructions('PointInstruction:BOYCARSS')
			
				-- Yellow,Black
			elseif feature.buoyShape == 2 and feature.colour[1] == 6 and feature.colour[2] == 2 and feature.topmark then
				featurePortrayal:AddInstructions('PointInstruction:BOYCARNB')
			...
			elseif feature.buoyShape == 5 and feature.colour[1] == 6 and feature.colour[2] == 2 then
				featurePortrayal:AddInstructions('PointInstruction:BOYCARNS')			
