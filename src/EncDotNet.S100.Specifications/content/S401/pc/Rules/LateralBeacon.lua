	...
	if feature.PrimitiveType == PrimitiveType.Point then
		if contextParameters.SimplifiedSymbols then
			...
			elseif feature.colour[1] == 4 and feature.colour[2] == 3 and feature.colour[3] == 4 then
				featurePortrayal:AddInstructions('PointInstruction:BCNLAT16')
			elseif feature.colour[1] == 3 and feature.colour[2] == 4  then
				featurePortrayal:AddInstructions('PointInstruction:BCNLAT23')
			...
			elseif feature.beaconShape == 5 and feature.colour[1] == 3 and feature.colour[2] == 4 and feature.colour[3] == 3 then
				...
				-- DIRECTION OF IMPACT
				featurePortrayal:AddInstructions('PointInstruction:DIRIMP')
			...
			elseif feature.beaconShape == 1 then
				...
				--	featurePortrayal:AddTextInstruction(EncodeString(feature.orientationValue, 'bn %s'), textViewingGroup, textPriority, viewingGroup, priority)
				--end    
