...
public sealed class S122DatasetProcessor : IDatasetProcessor
{
        ...
        FeatureCatalogueManager? featureCatalogueManager)
    {
        ...
        _decoder = featureCatalogueManager?.GetDecoder("S-122");
    }
    ...
    public DatasetResult Render(RenderContext? context = null)
    {
        ...
        var featureSource = new GmlFeatureXmlSource<S122Feature>(_dataset.Features);
    ...
    private FeatureInfo BuildFeatureInfo(S122Feature feature)
    {
