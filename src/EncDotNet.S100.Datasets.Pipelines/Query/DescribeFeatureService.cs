...
/// <summary>Request payload for <see cref="DescribeFeatureService"/>.</summary>
...
/// <summary>Result of <see cref="DescribeFeatureService"/>.</summary>
...
/// </summary>
public sealed class DescribeFeatureService
{
    ...
    /// <summary>Creates a new <see cref="DescribeFeatureService"/> with the default registry.</summary>
    public DescribeFeatureService(IDatasetCatalog catalog)
        : this(catalog, FeatureDescriberRegistry.Default)
    {
    }

    /// <summary>Creates a new <see cref="DescribeFeatureService"/> with a custom registry.</summary>
    public DescribeFeatureService(IDatasetCatalog catalog, FeatureDescriberRegistry registry)
    {
