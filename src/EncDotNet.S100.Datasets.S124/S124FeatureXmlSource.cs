...
/// <summary>
/// Projects an <see cref="S124Dataset"/> into the S-100 Part 9 FeatureXML
/// intermediate format for consumption by S-124 XSLT portrayal rules.
/// </summary>
/// <remarks>
/// The S-124 XSLT rules (main.xsl) expect input in this form:
/// <code>
/// &lt;Dataset&gt;
///   &lt;Features&gt;
...
/// </code>
/// </remarks>
public sealed class S124FeatureXmlSource : IFeatureXmlSource
{
    ...
    private XDocument BuildFeatureXml()
    {
        ...
        foreach (var feature in _dataset.Features)
        {
            ...
            {
                S124GeometryType.Point => "Point",
                S124GeometryType.Curve => "Curve",
                S124GeometryType.Surface => "Surface",
                _ => "NoGeometry",
            };
